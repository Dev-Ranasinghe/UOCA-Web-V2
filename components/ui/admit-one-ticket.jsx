...
var REF = 741;
var PRESERVE_BUFFER = { preserveDrawingBuffer: true };
var TICKET_GEOMETRY = {
  aspect: 741 / 425,
  cornerRadius: 25 / REF,
  notchRadius: 21 / REF,
...
function TicketCard({
  ...
  const scale = fitScale(lines, {
    availableWidth: (layout.nameRight != null ? layout.nameRight * width : perfX - 0.03 * width) - layout.padding * width,
