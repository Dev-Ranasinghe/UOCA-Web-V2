...
const MarqueeAlongSvgPath = ({
  ...
  // useId is stable across server and client renders; a random id caused a hydration mismatch.
...
// Each item gets its own component instance so its motion-value hooks have a
// stable call order, independent of how many items the parent renders.
const MarqueeItem = ({
  itemKey,
  child,
  repeatIndex,
